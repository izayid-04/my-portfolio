...
// ─── Contenu de détail d'un diplôme (description + document officiel) ────────
function CertDetailBody({ cert }: { cert: Certification }) {
  const t = useTranslations("certifications")
  const media = cert.images?.length ? cert.images : cert.image ? [cert.image] : []
        ...
        {pdfSrc ? (
          <div className="space-y-2">
            ...
            <div className="flex justify-end">
              ...
              >
                <FileText className="size-3.5" /> {t("openRawPdf")}
...
export function CertificationsSection({
  ...
  return (
    ...
    >
      ...
      {/* ═══ MOBILE : ACCORDÉON — chaque carte s'élargit sur elle-même ═══ */}
        ...
        {certs.map((cert, i) => {
          ...
          return (
            <motion.div
              ...
              className={cn(
                "rounded-2xl border transition-colors duration-300 overflow-hidden shadow-xs",
                isSelected
            ...
            >
              <button
                ...
                className="group relative flex w-full items-center gap-3 px-4 py-3 text-left cursor-pointer"
              >
                {cert.logo ? (
      ...
      {/* ═══ DESKTOP : liste de pastilles + cadre de détail séparé (inchangé) ═══ */}
        ...
        <AnimatePresence mode="wait">
          {selectedCert && (
            ...
            >
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {t("issuedBy")} <strong className="text-foreground">{selectedCert.issuer}</strong>
                    </p>
                  </div>
                </div>
              ...
              <CertDetailBody cert={selectedCert} />
            </motion.div>
          )}
        </AnimatePresence>
      </div>
