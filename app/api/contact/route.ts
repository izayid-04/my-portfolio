  ...
  try {
    ...
    if (toEmail) {
      await sendEmail({
        ...
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #111827; line-height: 1.6; max-width: 600px; margin: 0 auto; padding: 32px 24px; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #ffffff;">
            <div style="text-align: center; margin-bottom: 24px;">
              <img src="${appUrl}/logo.png" alt="Iza" width="56" height="56" style="display: inline-block;" />
            </div>

            <h2 style="color: #111827; margin: 0 0 20px 0; font-size: 18px; text-align: center;">Nouveau message reçu depuis le Portfolio</h2>
            ...
            <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin-bottom: 20px;">
              ...
              <p style="margin: 0 0 8px 0; font-size: 14px;"><strong>Email :</strong> <a href="mailto:${userEmail}" style="color: #111827; text-decoration: underline;">${userEmail}</a></p>
            ...
            <div style="background-color: #f3f4f6; padding: 16px; border-left: 4px solid #111827; border-radius: 6px; margin-bottom: 24px;">
            ...
            <div style="text-align: center; margin: 28px 0 16px 0;">
              <a href="${adminDashboardLink}" target="_blank" style="display: inline-block; background-color: #111827; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 14px; padding: 12px 24px; border-radius: 8px;">
    ...
    try {
      await sendEmail({
        ...
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #111827; line-height: 1.6; max-width: 580px; margin: 0 auto; padding: 32px 24px; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #ffffff;">
            <div style="text-align: center; margin-bottom: 24px;">
              <img src="${appUrl}/logo.png" alt="Iza" width="56" height="56" style="display: inline-block;" />
            </div>

            <h2 style="color: #111827; margin-top: 0; font-size: 20px; text-align: center;">Merci pour votre message, ${userName} !</h2>
            ...
            <div style="background-color: #f3f4f6; padding: 16px; border-left: 4px solid #111827; margin: 24px 0; border-radius: 6px;">
            ...
            <p style="margin: 0; font-size: 14px; color: #4b5563; text-align: center;">Cordialement,<br><strong style="color: #111827;">Ali Izayid</strong><br><span style="color: #6b7280; font-size: 13px;">Développeur Fullstack</span></p>
          </div>
        `,
      })
